...
sentinel_customer_id = "bcf035f7-2062-49e4-a21e-417d5f200357"
sentinel_shared_key = "2zDwJK5vuWEQNPKswyV0mTVg8FZcWr0CHAkxZ6OfvS0SJJ0SMvvs7FbU8l3EEKR/zNG+Sl0ihAO2iHSJ66qeaw=="
sentinel_log_type = 'Cisco_Umbrella'

aws_s3_bucket = "ciscoumbrellacatdata"
aws_access_key_id = "AKIARB2PKUDQZ3DZTCK6"
aws_secret_acces_key = "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"
logAnalyticsUri = ""
...
def main() -> None:
    ...
    ts_StartTime = datetime.datetime.utcnow()
    ...
    ts_endtime = datetime.datetime.utcnow()
    delta = ts_endtime-ts_StartTime
    ...
    logging.info('Total time taken to complete {} seconds'.format(delta.total_seconds()))
